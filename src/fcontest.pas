...
Uses LogGrid, LogStuff, LogSCP, keycode, logk1ea, scorereporter;
...
VAR TempQTH: QTHRecord;
    ...
    IF CMD = 'FIELD DAY' THEN
        BEGIN
        scorerpt.setcontest ('ARRL-FIELD-DAY');
    ...
    IF (CMD = 'JA INTERNATIONAL DX') OR (CMD = 'JIDX') THEN
        BEGIN
        scorerpt.setcontest ('JIDX-$');  { $ will be mode }
    ...
    IF CMD = 'STEW PERRY' THEN
        BEGIN
        scorerpt.setcontest ('STEW-PERRY');
    ...
    IF CMD = '7QP' THEN
        BEGIN
        scorerpt.setcontest ('7QP-QSO-PARTY');
    ...
    IF CMD = 'ALL ASIAN' THEN
        BEGIN
        scorerpt.setcontest ('AA-$');  { $ will be mode }
    ...
    IF CMD = 'ARRL 10' THEN
        BEGIN
        scorerpt.setcontest ('ARRL-10');  { $ will be mode }
...

    ...
    IF CMD = 'ARRL DX' THEN
        BEGIN
        scorerpt.setcontest ('ARRL-DX-$');  { $ will be mode }
    ...
    IF CMD = 'AP SPRINT' THEN
        BEGIN
        scorerpt.setcontest ('AP-Sprint-$');  { $ will be mode }
    ...
    IF CMD = 'BALTIC' THEN
        BEGIN
        scorerpt.setcontest ('BALTIC-CONTEST');
    ...
    IF (CMD = 'CAL QSO PARTY') OR (CMD = 'CQP') OR (CMD = 'CALIFORNIA QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('CA-QSO-PARTY');
    ...
    IF CMD = 'CQ 160' THEN
        BEGIN
        scorerpt.setcontest ('CQ-160-$');  { $ will be mode }
    ...
    IF CMD = 'CQ WPX' THEN
        BEGIN
        scorerpt.setcontest ('CQ-WPX-$');  { $ will be mode }
...

    ...
    IF CMD = 'CQ WPX RTTY' THEN
        BEGIN
        scorerpt.setcontest ('CQ-WPX-RTTY');
...

    ...
    IF CMD = 'CQ WW' THEN
        BEGIN
        scorerpt.setcontest ('CQ-WW-$');  { $ will be mode }
    ...
    IF CMD = 'CQ WW RTTY' THEN
        BEGIN
        scorerpt.setcontest ('CQ-WW-RTTY');
    ...
    IF CMD = 'CROATIAN' THEN
     ...
     IF CMD = 'CWO' THEN
        BEGIN
        scorerpt.setcontest ('CWOPS-Open');
    ...
    IF (CMD = 'FQP') OR (CMD = 'FLORIDA QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('FL-QSO-PARTY');
    ...
    IF CMD = 'JARTS' THEN
        BEGIN
        scorerpt.setcontest ('JARTS-WW-RTTY');
    ...
    IF (CMD = 'MICHIGAN QSO PARTY') OR (CMD = 'MICH QSO PARTY') OR (CMD = 'MI QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('MI-QSO-PARTY');
    ...
    IF (CMD = 'MARCONI MEMORIAL') OR (CMD = 'MMC') THEN
        BEGIN
        scorerpt.setcontest ('MARCONIMEMORIAL');
    ...
    IF (CMD = 'MINNESOTA QSO PARTY') OR (CMD = 'MINN QSO PARTY') OR (CMD = 'MN QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('MN-QSO-PARTY');
    ...
    IF CMD = 'NA QSO' THEN
        BEGIN
        scorerpt.setcontest ('NAQP-$');  { $ will be mode }
    ...
    IF (CMD = 'NEW ENGLAND QSO') OR (CMD = 'NEQSO') OR (CMD = 'NEW ENGLAND QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('NEWE-QSO-PARTY');  { $ will be mode }
    ...
    IF (CMD = 'NEW YORK QSO PARTY') OR (CMD = 'NY QSO') OR (CMD = 'NYQP') THEN
        BEGIN
        scorerpt.setcontest ('NY-QSO-PARTY');
    ...
    IF CMD = 'NRAU BALTIC' THEN
        BEGIN
        scorerpt.setcontest ('NRAU-$');  { $ will be mode }
    ...
    IF CMD = 'OHIO QSO PARTY' THEN
        BEGIN
        scorerpt.setcontest ('OH-QSO-PARTY');
    ...
    IF CMD = 'SALMON RUN' THEN
        BEGIN
        scorerpt.setcontest ('WA-QSO-PARTY');
    ...
    IF CMD = 'SP DX' THEN
        BEGIN
        scorerpt.setcontest ('SP-DX');  { $ will be mode }
    ...
    IF CMD = 'SWEEPSTAKES' THEN
        BEGIN
        scorerpt.setcontest ('ARRL-SS-$');  { $ will be mode }
    ...
    IF CMD = 'TEXAS QSO PARTY' THEN
        BEGIN
        scorerpt.setcontest ('TX-QSO-PARTY');
    ...
    IF CMD = 'UKRAINIAN' THEN
        BEGIN
        scorerpt.setcontest ('UKRAINIAN-DX');
    ...
    IF (CMD = 'VK ZL') OR (CMD = 'OCEANIA') THEN
        BEGIN
        scorerpt.setcontest ('Oceania-DX-$');  { $ will be mode }
    ...
    IF CMD = 'WAE' THEN
        BEGIN
        scorerpt.setcontest ('DARC-WAEDC-$');  { $ will be mode }
    ...
    IF (CMD = 'WQP') OR (CMD = 'WISCONSIN QSO PARTY') THEN
        BEGIN
        scorerpt.setcontest ('WI-QSO-PARTY');
